		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Attachment upload select",
									"targetURL": "#usattachmentusattachment-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"usattachmentusattachment-display": {
								"semanticObject": "usattachmentusattachment",
								"action": "display",
								"description": "Attachment upload select",
								"title": "Attachment upload select",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=usattachment.usattachment",
									"url": sap.ui.require.toUrl("usattachment/usattachment")
								}
							}
						}
					}
