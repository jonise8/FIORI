		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Attachment Donwload",
									"targetURL": "#attachdownattachdown-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"attachdownattachdown-display": {
								"semanticObject": "attachdownattachdown",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=attachdown.attachdown",
									"url": sap.ui.require.toUrl("attachdown/attachdown")
								}
							}
						}
					}
