		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Demo CDS sin Template",
									"targetURL": "#democdswithouttemplatedemocdswithouttemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"democdswithouttemplatedemocdswithouttemplate-display": {
								"semanticObject": "democdswithouttemplatedemocdswithouttemplate",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=democdswithouttemplate.democdswithouttemplate",
									"url": sap.ui.require.toUrl("democdswithouttemplate/democdswithouttemplate")
								}
							}
						}
					}
